...
public:
    ...
    void begin(unsigned long baud, uint32_t config=SERIAL_8N1, int8_t rxPin=19, int8_t txPin=18, bool invert=false, unsigned long timeout_ms = 20000UL, uint8_t rxfifo_full_thrhd = 112);
    ...
    void setPins(int8_t rxPin, int8_t txPin, int8_t ctsPin = 19, int8_t rtsPin = 18);
